...
fn run_corpus_scan(
    ...
    for adv in all_advisories.drain(..) {
        ...
        let key = (
            adv.file_path.clone(),
            adv.enclosing_symbol.clone().unwrap_or_default(),
            category,
        );

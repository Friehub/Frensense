...
pub static MOTIFS: &[Motif] = &[
    Motif {
        ...
        members: &[
            ...
            "popen", "system", "ShellExecute",
        ],
    },
    Motif {
        name: "SqlSink",
        members: &[
            "query", "execute", "raw", "raw_query",
            "sql_query", "Statement.execute", "execute_query",
            "prepare", "db.run", "knex.raw",
        ],
    },
    Motif {
    ...
    Motif {
        ...
        members: &[
            ...
            "fs::read", "read_to_string", "File::open",
            "open", "fopen",
        ],
    },
    Motif {
        ...
        members: &[
            ...
            "fs::write", "write_all", "File::create",
        ],
    },
    Motif {
        name: "DeserializeSink",
        members: &[
            "JSON.parse", "from_str", "loads", "deserialize",
            "serde_json::from_str", "yaml.load", "pickle.loads",
            "bincode::deserialize",
        ],
    },
    Motif {
    ...
    Motif {
        ...
        members: &[
            ...
            "res.status", "res.end", "res.write",
            "response.send", "Response::json", "Response::error",
        ],
    },
    Motif {
        name: "CryptoWeakSink",

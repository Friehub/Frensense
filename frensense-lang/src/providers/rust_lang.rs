...
impl LanguageSpec for RustSpec {
    ...
    fn known_sink_names(&self) -> &'static [(&'static str, crate::spec::SinkLabel)] {
        &[
            ...
            ("fetch", crate::spec::SinkLabel::SqlInjection),
            ("fetch_one", crate::spec::SinkLabel::SqlInjection),
            ("fetch_all", crate::spec::SinkLabel::SqlInjection),
            ("query", crate::spec::SinkLabel::SqlInjection),
            ("query_as", crate::spec::SinkLabel::SqlInjection),
            ...
            ("arg", crate::spec::SinkLabel::CommandInjection),
            ("args", crate::spec::SinkLabel::CommandInjection),
            ("status", crate::spec::SinkLabel::CommandInjection),
            ...
            // SSRF
            ("reqwest::get", crate::spec::SinkLabel::Ssrf),
            ("Client::get", crate::spec::SinkLabel::Ssrf),
            ("ureq::get", crate::spec::SinkLabel::Ssrf),
            ...
            // Unsafe Memory
            ("transmute", crate::spec::SinkLabel::UnsafeMemory),
            ("transmute_copy", crate::spec::SinkLabel::UnsafeMemory),
            ("from_utf8_unchecked", crate::spec::SinkLabel::UnsafeMemory),
            ("from_raw_parts", crate::spec::SinkLabel::UnsafeMemory),

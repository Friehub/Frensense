...
// GenSense v0.2.0 (Regex) would say: "I see 'return false', it's fine."
// GenSense v0.3.0 (Reachability) should say: "The comment doesn't count. CRITICAL."
...
// GenSense v0.3.0 should suppress this finding.

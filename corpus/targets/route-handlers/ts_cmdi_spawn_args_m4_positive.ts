// [frensense]
// observation: User-controlled input is passed as an argument to spawn, enabling argument injection through a helper function.
...
async function handlerA(req: Request, res: Response) {
    const val = getValue(req.body.file);
...
async function handlerB(req: Request, res: Response) {
    const val = prepareInput(req.body.output);

// SAFE: RSC payload component name is validated against an allowlist before dynamic import
// CVE: CVE-2025-66478
...
function validatePayload(raw: unknown): { component: AllowedComponent; props: Record<string, unknown> } {

...
// SAFE: custom comparison that correctly identifies unchanged props
export default memo(ExpensiveChart, (prev, next) => {
  return prev.title === next.title && prev.data.length === next.data.length && prev.data.every((v, i) => v === next.data[i])
})

// SAFE: Uses controlled value to prevent all panels from collapsing — at least the 'terms' panel stays open at all times
...
export function TermsAccordion() {
  return (
    <Accordion.Root type="multiple" value={['terms']}>

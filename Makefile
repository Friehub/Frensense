...
bench-nodegoat:
	@echo "[BENCH] Evaluating NodeGoat ground truth..."
	cargo build --release --bin frensense
	FRENSENSE_BIN=target/release/frensense python3 scripts/benchmark_nodegoat.py

    ...
    ProbeTemplate {
        ...
        probes: vec![
            Probe {
                ...
                risk: ProbeRisk::Safe,
                description: "IDOR — increment resource ID, check if unauthorized data is returned".to_string(),
            },
            Probe {
                id: Uuid::new_v4().to_string(),
                ...
                risk: ProbeRisk::Safe,
                description: "IDOR — high resource ID may return 403/404 if properly protected".to_string(),
            },
            Probe {
                id: Uuid::new_v4().to_string(),
                payload: "-1".to_string(),

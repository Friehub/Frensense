...
content = open("frensense-bundler/src/auto_filter.rs").read()

# The new AST extractor
ast_extractor = """
pub fn extract_call_targets(source: &str) -> std::collections::HashSet<String> {
...
open("frensense-bundler/src/auto_filter.rs", "w").write(content)
